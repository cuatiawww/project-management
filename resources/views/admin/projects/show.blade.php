    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Kelola detail project dan tim</p>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                            {{ $project->members->count() + 1 }} Anggota
                        </span>
                    </div>
                </div>
                <div class="p-6">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ $project->members->count() + 1 }}</span>
                        </div>
                        <div class="flex items-center justify-between">
