...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('admin.users.show', $user) }}" 
                   class="inline-flex items-center px-4 py-2 bg-gray-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-600 active:bg-gray-800 focus:outline-none focus:border-gray-800 focus:ring ring-gray-400 disabled:opacity-25 transition ease-in-out duration-150">
                    Lihat Detail
                </a>
            </div>
        </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <!-- Current User Info -->
        <div class="px-6 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 border-b border-gray-200">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div class="h-12 w-12 rounded-full flex items-center justify-center
                        @if($user->role->name == 'admin') bg-red-500
                        @elseif($user->role->name == 'project_manager') bg-green-500
                        @else bg-purple-500
                        @endif shadow-lg bg-opacity-50">
                ...
                <div class="ml-4">
                    <h2 class="text-lg font-medium text-white">Edit: {{ $user->name }}</h2>
                    <p class="text-indigo-100 text-sm">{{ $user->email }} • {{ $user->role->display_name }}</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>Anda sedang mengedit akun Anda sendiri. Berhati-hatilah saat mengubah role atau status aktif.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-blue-800">Informasi Perubahan</h3>
                <div class="mt-2 text-sm text-blue-700">
                    <ul class="space-y-1">
                        ...
                        <li>• User yang di-nonaktifkan tidak dapat login ke sistem</li>
                        <li>• Terakhir diupdate: {{ $user->updated_at->format('d F Y H:i') }}</li>
                    </ul>
                </div>
            </div>
        </div>
